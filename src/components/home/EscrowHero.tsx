...
export function EscrowHero({
  ...
  return (
    <section className="relative overflow-hidden rounded-card bg-gradient-to-br from-[#2F6F5E] to-[#173D33] p-5 text-white shadow-lift ring-1 ring-inset ring-white/10 lg:p-8">
      ...
      />
      <ShieldCheck className="pointer-events-none absolute -right-4 -top-4 h-28 w-28 text-white/15 animate-float-y lg:h-40 lg:w-40" />
...
function ValueProp({
  ...
  return (
    <div>
      <h1 className="text-[24px] font-bold leading-[1.15] tracking-tight lg:text-[32px]">
        Get paid safely.
        <br />
        Or get it all back.
      </h1>
      <p className="mt-1.5 text-[13px] leading-relaxed text-white/80 lg:text-[15px]">
        Funds lock on-chain until the buyer confirms delivery.
      </p>

      <div className="lg:mt-5 lg:grid lg:max-w-2xl lg:grid-cols-2 lg:gap-3">
      {connected ? (
        <Link
          to="/create/new"
